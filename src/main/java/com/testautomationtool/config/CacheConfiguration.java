...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.testautomationtool.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.testautomationtool.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.testautomationtool.domain.User.class.getName());
            ...
            createCache(cm, com.testautomationtool.domain.TestScenario.class.getName() + ".stepDefinitions");
            createCache(cm, com.testautomationtool.domain.StepDefinition.class.getName());
        };
    }
