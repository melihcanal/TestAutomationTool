        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Status" id="test-scenario-status" name="status" data-cy="status" check type="checkbox" />
              <ValidatedField label="Message" id="test-scenario-message" name="message" data-cy="message" type="text" />
              <ValidatedField label="Report Url" id="test-scenario-reportUrl" name="reportUrl" data-cy="reportUrl" type="text" />
