...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTSCENARIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTSCENARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTSCENARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTSCENARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTSCENARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTSCENARIO actions', async () => {
      const expectedActions = [
        {
