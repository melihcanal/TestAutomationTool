...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STEPDEFINITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_STEPDEFINITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STEPDEFINITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STEPDEFINITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STEPDEFINITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STEPDEFINITION actions', async () => {
      const expectedActions = [
        {
