...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTEXECUTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTEXECUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTEXECUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTEXECUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTEXECUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTEXECUTION actions', async () => {
      const expectedActions = [
        {
